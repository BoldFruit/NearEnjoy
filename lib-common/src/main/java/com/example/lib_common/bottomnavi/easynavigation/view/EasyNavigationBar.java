package com.example.lib_common.bottomnavi.easynavigation.view;
...
import com.example.lib_common.bottomnavi.easynavigation.adapter.ViewPagerAdapter;
...
public class EasyNavigationBar extends LinearLayout {
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        bottomSheetLayout = contentView.findViewById(R.id.relayout_bottom_sheet);
...
//若没有设置中间添加的文字字体大小、颜色、则同其他Tab一样
    ...
    public void setBottomSheetLayout(View bottomSheetLayout) {
        LinearLayout.LayoutParams addParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        this.bottomSheetLayout.addView(bottomSheetLayout, addParams);
