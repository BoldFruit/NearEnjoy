...
import com.example.lib_common.imageview.gallery.adapter.GalleryPhotoAdapter;
import com.example.lib_common.imageview.gallery.model.GalleryPhotoModel;
import com.example.lib_common.imageview.gallery.model.GalleryPhotoParameterModel;
import com.example.lib_common.imageview.gallery.util.GalleryDownLoadCallBack;
import com.example.lib_common.imageview.gallery.util.GalleryDownloadThread;
import com.example.lib_common.imageview.gallery.util.GalleryScreenUtil;
...
public class GalleryView extends RelativeLayout {
    ...
    public void showPhotoGallery(int index, List<GalleryPhotoModel> photoList, ImageView clickImageView) {
        ...
        //scaleType
        photoParameter.scaleType = ImageView.ScaleType.CENTER_INSIDE;
...
//        boolean isFocus = requestFocus();
    ...
    private void initView() {
        View view = View.inflate(getContext(), R.layout.common_gallery_view_main, this);
