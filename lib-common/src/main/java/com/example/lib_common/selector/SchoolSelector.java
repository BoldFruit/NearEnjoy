package com.example.lib_common.selector;
...
public class SchoolSelector extends LinearLayout {
    ...
    private void initView() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.common_layout_select_school, this);
    ...
    public void setTxtProvince(String province) {
    ...
    public void setTxtSchool(String school) {
    ...
    public static class SelectorContent {
        String province;
        String city;
        String school;

        SelectorContent(String province, String city, String school) {
