...
public class WaveView extends View {
    ...
    private static final float DEFAULT_WAVE1_OFFSET_RATIO = 0.5f;
    private static final float DEFAULT_WAVE2_OFFSET_TO_WAVE1_RATIO = 0.25f;
    ...
    private float mWave1OffsetRatio = DEFAULT_WAVE1_OFFSET_RATIO;
    private float mWave2OffsetToWave1Ratio = DEFAULT_WAVE2_OFFSET_TO_WAVE1_RATIO;
    ...
    public void setWave1OffsetRaito(float mWave1OffsetRatio) {
        this.mWave1OffsetRatio = mWave1OffsetRatio;
        invalidate();
    }

    public void setWave2OffsetToWave1Raito(float mWave2OffsetToWave1Ratio) {
        this.mWave2OffsetToWave1Ratio = mWave2OffsetToWave1Ratio;
        invalidate();
    }
...
//            canvas.drawLine(beginX, beginY, beginX, endY, wavePaint);
        ...
        for (int beginX = 0; beginX < endX; beginX++) {
            canvas.drawLine(beginX, waveY[beginX], beginX, endY, wavePaint);
        }
