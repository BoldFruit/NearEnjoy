package com.example.lib_common.widget.banner;
...
import com.example.lib_common.widget.banner.config.BannerConfig;
import com.example.lib_common.widget.banner.config.IndicatorConfig;
import com.example.lib_common.widget.banner.indicator.Indicator;
...
public class Banner<T, BA extends BannerAdapter> extends FrameLayout {
    ...
    class BannerOnPageChangeCallback extends ViewPager2.OnPageChangeCallback {
        ...
        public void onPageScrollStateChanged(int state) {
            switch (state) {
                //正在拖动中，这里是为了能够使banner循环，当位于边界时，就进行position的跳转。
                case ViewPager2.SCROLL_STATE_DRAGGING:
                    ...
                    Log.e("state", "onPageScrollStateChanged: Dragging" + mCurrentPosition);
                    break;
            }
            if (pageListener != null) {
    ...
    /**
     * banner自动循环跳转的Runnable
     */
     class AutoLoopTask implements Runnable {
        //当banner没有任何的引用时，GC执行时，就能回收引用。
    ...
    private void initIndicator() {
        ...
        removeIndicator();
        addView(mIndicator.getIndicatorView(), 1);
        initIndicatorAttr();
    ...
    /**
     * 设置SlideIndicator中滑块的样式
     */
    public Banner setIndicatorType(@DrawableRes int res) {
        if (mIndicator != null) {
            mIndicator.getIndicatorConfig().setIndicatorType(res);
        }
        return this;
    }
    ...
    public Banner setIndicatorNormalColor(@ColorInt int color) {
        ...
        Log.d(TAG, "setIndicatorNormalColor:");
        return this;
    }
    ...
    public Banner setIndicatorNormalWidth(int normalWidth) {
        ...
        Log.d(TAG, "setIndicatorNormalWidth: ");
        return this;
    }
    ...
    public Banner setIndicatorSelectedWidth(int selectedWidth) {
        ...
        Log.d(TAG, "setIndicatorSelectedWidth: ");
        return this;
    }
