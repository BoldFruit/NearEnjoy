...
public class IndicatorConfig {
    ...
    @DrawableRes
    //SlideIndicator中的滑块样式
    private int indicatorType = BannerConfig.INDICATOR_TYPE;
    ...
    public IndicatorConfig setIndicatorType(int mIndicatorType) {
        if (mIndicatorType != indicatorType) {
