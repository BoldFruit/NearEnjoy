...
import com.neuqer.module_share.R;
...
//          Bitmap bt = bd.getBitmap();
     ...
     * @param uri
     */
    public void sharedQQ(Activity context, Uri uri, String title, String extraText){
        Intent imageIntent = new Intent(Intent.ACTION_SEND);
        imageIntent.setPackage("com.tencent.mobileqq");
        imageIntent.setType("image/*");
        imageIntent.putExtra(Intent.EXTRA_STREAM, uri);
        imageIntent.putExtra(Intent.EXTRA_TEXT,extraText);
        imageIntent.putExtra(Intent.EXTRA_TITLE,title);
